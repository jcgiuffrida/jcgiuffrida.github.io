...
### Further development
This open-source scatterplot was the basis for one of the analytics tools in [Metopio](https://metop.io), a data visualization platform I built and co-founded. There, it's tied into hundreds of datasets and allows visualization of statistically significant correlations in places across the country. 
...
* **Easy:** Sign up for [Metopio](https://metop.io) or [get in touch](https://metop.io/contact/).

<div style="text-align: center;"><a class="btn" href="https://metop.io/" style="padding: 10px 20%;">Learn more about Metopio</a></div>
